...
【スコア基準（必ずこの基準に従ってください）】
- 90〜100: 業界トップクラス。改善点がほぼない
- 75〜89: 良好。基本はできているが改善の余地あり
- 50〜74: 平均的。いくつかの重要な問題がある
- 25〜49: 不十分。多くの改善が必要
- 0〜24: 深刻な問題あり。根本的な見直しが必要

重要: スコアは上記の基準に厳密に従い、問題の数と重大度に基づいて算出してください。
「とりあえず70点前後」のような安易な評価は避け、具体的な根拠に基づいて採点してください。
severityがhighの指摘が1件あるごとに-10〜15点、mediumは-5〜8点、lowは-2〜3点を目安にしてください。
